...
<div id="right">
            ...
            <div class="panel-footer clearfix">
                <table class="table">
                    ...
                    <?php if(is_array($array)): $i = 0; $__LIST__ = $array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="/admin/index/help_edit.html?typeid=<?php echo ($vo["typeid"]); ?>">修改</a> <a href="javascript:void()" onclick="del('<?php echo ($vo["typeid"]); ?>');">删除</a></td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_949615846__=0;$__FOR_END_949615846__=$count;for($i=$__FOR_START_949615846__;$i < $__FOR_END_949615846__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_633918951__=1;$__FOR_END_633918951__=6;for($i=$__FOR_START_633918951__;$i < $__FOR_END_633918951__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_2104493540__=$count-4;$__FOR_END_2104493540__=$count+1;for($i=$__FOR_START_2104493540__;$i < $__FOR_END_2104493540__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_1891286462__=$page-2;$__FOR_END_1891286462__=$page+3;for($i=$__FOR_START_1891286462__;$i < $__FOR_END_1891286462__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/help.js" type="text/javascript" charset="utf-8"></script>