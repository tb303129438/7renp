...
<div id="right">
            ...
            <div class="panel-footer clearfix">
                ...
                <table class="table">
                    ...
                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td> <a href="/admin/index/order_view.html?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["orderid"]); ?></a></td>
                        <td>
                            <?php if(($vo["pic"]) == ""): ?><img   src="/Public/upload/bg.jpg" class="btnbg" style="width:50px;height:50px;left:0px;z-Index:-1;"/>
                            <?php else: ?>
                                <img   src="<?php echo ($vo["pic"]); ?>" class="btnbg" style="width:50px;height:50px;left:0px;z-Index:-1;"/><?php endif; ?>
                        </td>
                        ...
                        <td width="100px;">
                                <?php switch($vo["status"]): case "1": ?>下单<?php break;?>
                                    <?php case "2": ?>已付款 <a href="/admin/index/order_view.html?id=<?php echo ($vo["id"]); ?>" >发货</a><?php break;?>
                                    <?php case "3": ?>已发货　<?php break;?>
                                    <?php case "4": ?>交易成功<?php break;?>
                                    <?php case "5": ?>退货<?php break;?>
                                    <?php case "6": ?>关闭<?php break; endswitch;?>
</td>
                        <td><a href="/admin/index/order_view.html?id=<?php echo ($vo["id"]); ?>">修改</a> <a href="javascript:void()" onclick="del('<?php echo ($vo["id"]); ?>');">删除</a></td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_29387__=0;$__FOR_END_29387__=$count;for($i=$__FOR_START_29387__;$i < $__FOR_END_29387__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_16559__=1;$__FOR_END_16559__=6;for($i=$__FOR_START_16559__;$i < $__FOR_END_16559__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_22200__=$count-4;$__FOR_END_22200__=$count+1;for($i=$__FOR_START_22200__;$i < $__FOR_END_22200__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_11252__=$page-2;$__FOR_END_11252__=$page+3;for($i=$__FOR_START_11252__;$i < $__FOR_END_11252__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/order.js" type="text/javascript" charset="utf-8"></script>