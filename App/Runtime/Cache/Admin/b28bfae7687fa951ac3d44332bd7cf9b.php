...
<div id="right">
        ...
        <div class="index_cont">
            ...
            <div class="table-responsive table_box">
                ...
                <table class="table">
                    ...
                    <?php if(is_array($bd)): $i = 0; $__LIST__ = $bd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                        	<?php if($vo["tohelp"] == 0): ?><a href="/admin/index/dosqbd.html?id=<?php echo ($vo["id"]); ?>">审核</a> | 当前等级：普通会员
                            <?php else: ?>
                            	<a>已审核</a> | 当前等级：报单中心<?php endif; ?>
                        </td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_840481435__=0;$__FOR_END_840481435__=$count;for($i=$__FOR_START_840481435__;$i < $__FOR_END_840481435__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_770395213__=1;$__FOR_END_770395213__=6;for($i=$__FOR_START_770395213__;$i < $__FOR_END_770395213__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_1014365699__=$count-4;$__FOR_END_1014365699__=$count+1;for($i=$__FOR_START_1014365699__;$i < $__FOR_END_1014365699__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_378515086__=$page-2;$__FOR_END_378515086__=$page+3;for($i=$__FOR_START_378515086__;$i < $__FOR_END_378515086__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
