            ...
            <div class="table-responsive table_box">
                <div>
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#panel-32409" data-toggle="tab">管理员列表</a>
                        </li>
                    </ul>
                </div>
                <div class="selct">
                    <form class="form-inline" role="form">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">管理员帐户</div>
                                <input id="k" name="k" class="form-control " type="text" placeholder="输入管理员帐户" value="<?php echo ($keyword); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                ...
                <table class="table">
                    ...
                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            ...
                            <a href="/admin/index/adminedit.html?id=<?php echo ($vo["id"]); ?>">修改</a> <a href="javascript:void()" onclick="admindelete('<?php echo ($vo["id"]); ?>');" >删除</a>
                            </td>
...
<div>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_2105726870__=0;$__FOR_END_2105726870__=$count;for($i=$__FOR_START_2105726870__;$i < $__FOR_END_2105726870__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_307568672__=1;$__FOR_END_307568672__=6;for($i=$__FOR_START_307568672__;$i < $__FOR_END_307568672__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_736357426__=$count-4;$__FOR_END_736357426__=$count+1;for($i=$__FOR_START_736357426__;$i < $__FOR_END_736357426__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_1856981882__=$page-2;$__FOR_END_1856981882__=$page+3;for($i=$__FOR_START_1856981882__;$i < $__FOR_END_1856981882__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/admin.js" type="text/javascript" charset="utf-8"></script>