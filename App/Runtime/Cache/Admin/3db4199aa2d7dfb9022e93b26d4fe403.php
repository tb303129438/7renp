    ...
    <div class="main">
        <div class="index_cont">
            ...
            <div class="table-responsive table_box">
             ...
             <?php if($ben["tohelp"] == 0): if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>

                        <!-- <td><?php echo ($vo["id"]); ?></td> -->
                        <td><?php echo ($vo["username"]); ?></td>
                        <td><?php echo ($vo["realname"]); ?></td>
                        <td><?php echo ($vo["mobile"]); ?></td>
                        <td><?php echo ($vo["tusername"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                        <!--<td>
                            <?php switch($vo["status"]): case "0": ?>等待激活<?php break;?>
                                <?php case "1": ?>已经激活<?php break;?>
                                <!--<?php case "2": ?>已经休眠<?php break;?>-->
                                <!--<?php case "3": ?>已经冻结<?php break;?>-->
                            <!--<?php endswitch;?>
                        </td>-->
<td><?php echo ($vo["fwzx"]); ?></td>
                        <td>
                            <!--<?php switch($vo["status"]): case "0": ?><a href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',1)">开通</a><?php break;?>
                                <?php case "1": ?><a href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',3)">冻结</a> | <a  href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',2)">休眠</a><?php break;?>
                                <?php case "2": ?><a href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',1)">开通</a> | <a href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',3)">冻结</a><?php break;?>
                                <?php case "3": ?><a href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',1)">开通</a> | <a  href="javascript:void();" onclick="changestatus('<?php echo ($vo["id"]); ?>',2)">休眠</a><?php break; endswitch;?> -->
                           
                           	<!--<?php if($vo["status"] == 0): ?><a href="/pc/wo/jh.html?id=<?php echo ($vo["id"]); ?>">激活| </a> <?php else: ?><span style="color: #23527c;">已激活 </span> |<?php endif; ?>-->
                          
                           
                            <a href="/admin/index/profile.html?id=<?php echo ($vo["id"]); ?>">修改</a> | <a href="/admin/index/user_password.html?id=<?php echo ($vo["id"]); ?>">修改密码</a>
                            |  <a href="javascript:void();" onclick="deleteuser('<?php echo ($vo["id"]); ?>')">删除</a> 
                           <br>
                           
                              |
                            <a href="/admin/index/login?id=<?php echo ($vo["id"]); ?>" target="_blank">进入会员中心</a>
                        </td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_31708__=0;$__FOR_END_31708__=$count;for($i=$__FOR_START_31708__;$i < $__FOR_END_31708__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_4406__=1;$__FOR_END_4406__=6;for($i=$__FOR_START_4406__;$i < $__FOR_END_4406__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_13869__=$count-4;$__FOR_END_13869__=$count+1;for($i=$__FOR_START_13869__;$i < $__FOR_END_13869__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_7655__=$page-2;$__FOR_END_7655__=$page+3;for($i=$__FOR_START_7655__;$i < $__FOR_END_7655__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/member.js" type="text/javascript" charset="utf-8"></script>