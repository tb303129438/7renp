...
<div id="right">
            ...
            <div class="panel-footer clearfix">
                ...
                <table class="table">
                    ...
                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                        <?php if($vo["syqf"] == 0): ?>无
                        <?php elseif($vo["syqf"] == 1): ?>
                            今日推荐
                        <?php else: ?> 
                            精选优车<?php endif; ?>
                        </td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                        <td><a href="/admin/index/product_edit.html?id=<?php echo ($vo["id"]); ?>&o=<?php echo ($o); ?>">修改</a> <a href="javascript:void()" onclick="del('<?php echo ($vo["id"]); ?>');">删除</a></td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_25322__=0;$__FOR_END_25322__=$count;for($i=$__FOR_START_25322__;$i < $__FOR_END_25322__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_25594__=1;$__FOR_END_25594__=6;for($i=$__FOR_START_25594__;$i < $__FOR_END_25594__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_20770__=$count-4;$__FOR_END_20770__=$count+1;for($i=$__FOR_START_20770__;$i < $__FOR_END_20770__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_21009__=$page-2;$__FOR_END_21009__=$page+3;for($i=$__FOR_START_21009__;$i < $__FOR_END_21009__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/product.js" type="text/javascript" charset="utf-8"></script>