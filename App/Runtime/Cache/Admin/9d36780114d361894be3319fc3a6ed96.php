                    ...
                    <div class="tabbable" id="tabs-184023">
                        <div>
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#panel-32409" data-toggle="tab">新建管理员账户</a>
                                </li>
                            </ul>
                        </div>
                        <div class="wxts2"></div>
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel-32409">
                                <div class="xjzh">
                                    <div class="container-fluid">
                                        <form class="form-horizontal" id="form" name="form" method="post" action="/admin/index/doadminadd.html">
                                            <div class="row btred">
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">管理员帐户<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="text" class="form-control" id="username" name="username" placeholder="输入管理员帐户">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-sm-4">
                                                        <input type="text" class="form-control" id="job" name="job" placeholder="输入职位">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-sm-4">
                                                        ...
                                                        <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label name="power<?php echo ($vo["id"]); ?>" ><input type="checkbox"   name="power[]" value="<?php echo ($vo["id"]); ?>" onclick="checkboxClick('power','<?php echo ($vo["id"]); ?>',this);"> <?php echo ($vo["title"]); ?></label>
                                                            <br>
                                                            
                                                            <?php if(is_array($vo["sub"])): $i = 0; $__LIST__ = $vo["sub"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;&nbsp;&nbsp;<label name="powersub<?php echo ($vo["id"]); ?>" onclick="checkboxClick('<?php echo ($vo["id"]); ?>',this);"><input type="checkbox"   name="power[]" value="<?php echo ($vo1["id"]); ?>" onclick="checkboxsubClick('<?php echo ($vo["id"]); ?>',this);"> <?php echo ($vo1["title"]); ?></label><br><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
...
<script src="/Public/Admin/js/adminadd.js" type="text/javascript" charset="utf-8"></script>