...
<div id="right">
            ...
            <div class="panel-footer clearfix">
                ...
                <table class="table">
                    ...
                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["username"]); ?><br>(<?php echo ($vo["realname"]); ?>)</td>
                        <td><?php echo ($vo["price"]); ?>
                        <br>(<?php if($vo["cotegary"] == 1): ?>推广积分<?php else: ?>消息积分<?php endif; ?>)</td>
                        <td><?php echo ($vo["sjje"]); ?></td>
                        ...
                        <?php if($vo["zt"] == 0): ?><td><a href="/admin/index/dotxjl_edit?userid=<?php echo ($vo["id"]); ?>">审核</a> 
                        <?php else: ?>
                            <td><a>已审核</a><?php endif; ?>
                        <!-- <a href="javascript:void()" onclick="del('<?php echo ($vo["id"]); ?>');">删除</a></td> -->
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_970829897__=0;$__FOR_END_970829897__=$count;for($i=$__FOR_START_970829897__;$i < $__FOR_END_970829897__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_1784678024__=1;$__FOR_END_1784678024__=6;for($i=$__FOR_START_1784678024__;$i < $__FOR_END_1784678024__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_1407785303__=$count-4;$__FOR_END_1407785303__=$count+1;for($i=$__FOR_START_1407785303__;$i < $__FOR_END_1407785303__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_721179105__=$page-2;$__FOR_END_721179105__=$page+3;for($i=$__FOR_START_721179105__;$i < $__FOR_END_721179105__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/txjl.js" type="text/javascript" charset="utf-8"></script>