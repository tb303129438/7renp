...
<div id="right">
    ...
    <div class="main">
        ...
        <div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
					<div class="tabbable" id="tabs-992947">
						<ul class="nav nav-tabs">
							<li>
								<a href="#panel-354063" data-toggle="tab">修改登录密码</a>
							</li>
							<li class="active">
								<a href="#panel-589644" data-toggle="tab">修改安全密码</a>
							</li>
							<li >
								<a href="javascript:voie()" onclick="javascript:history.go(-1);" data-toggle="tab">返回</a>
							</li>
						</ul>
						<div class="wxts2">
                            <p><i class="glyphicon glyphicon-play"></i>&nbsp;温馨提示</p>
                            <p class="borcent"></p>
                            <h2>为了您的账户安全，请及时修改密码，尽量保持登录密码和安全密码的不同。</h2>
                        </div>
						<div class="tab-content bgcolor-d5e2eb">
							<div class="tab-pane" id="panel-354063">
							...
							<div class="tab-pane active" id="panel-589644">
								<div class="dlmm">
	                                    <form class="form-horizontal" role="form">
...
<script src="/Public/Admin/js/user_password.js" type="text/javascript" charset="utf-8"></script>