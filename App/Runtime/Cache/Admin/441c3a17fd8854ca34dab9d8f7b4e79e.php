                     ...
                     <form class="form-inline" role="form"> 
                       ...
                       <div class="form-group">
                            <div class="input-group">
                                ...
                                <input id="k" name="k" class="form-control " type="text" placeholder="输入关键字" value="<?php echo ($keyword); ?>" >		<!--onkeyup="showMe()"-->
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
...
//                          }
                ...
                <table class="table">
                    ...
                    <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="showJifen">
                        
                        <td><?php echo ($vo["username"]); ?></td>
                        <td><?php echo ($vo["title"]); ?></td>
                        <td><?php if($vo["status"] == 1): ?>+
                        <?php else: ?>
                            -<?php endif; echo ($vo["price"]); ?></td>
                         <td><?php switch($vo["gotegary"]): case "1": ?>现金积分<?php break;?> 
                             <?php case "2": ?>报单积分<?php break;?>
                             <?php case "4": ?>消费积分<?php break; endswitch;?>      
                         </td>
                        <td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td>
                        <td>
                        <?php if($vo["status"] == 1): ?>收入
                        <?php else: ?>
                            支出<?php endif; ?>
                        </td>
    ...
    <nav>
        <ul class="pagination pagination-sm pull-right">
            ...
            <?php if($count < 5): $__FOR_START_907825318__=0;$__FOR_END_907825318__=$count;for($i=$__FOR_START_907825318__;$i < $__FOR_END_907825318__;$i+=1){ if($page == $i+1): ?><li class="active"><a ><?php echo ($i+1); ?></a></li>
                        <?php else: ?>
                        <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i+1); echo ($search); ?>"><?php echo ($i+1); ?></a></li><?php endif; } ?>
                <?php else: ?>
                <?php if($page <= 2): $__FOR_START_1966301313__=1;$__FOR_END_1966301313__=6;for($i=$__FOR_START_1966301313__;$i < $__FOR_END_1966301313__;$i+=1){ if(($i) == $page): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($page); echo ($search); ?>" ><?php echo ($page); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php elseif($count-$page < 5): ?>
                    <?php $__FOR_START_824643585__=$count-4;$__FOR_END_824643585__=$count+1;for($i=$__FOR_START_824643585__;$i < $__FOR_END_824643585__;$i+=1){ if(($page) == $i): ?><li class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>" ><?php echo ($i); ?></a></li>
                            <?php else: ?>
                            <li ><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li><?php endif; } ?>
                    <?php else: ?>
                    <?php $__FOR_START_215366609__=$page-2;$__FOR_END_215366609__=$page+3;for($i=$__FOR_START_215366609__;$i < $__FOR_END_215366609__;$i+=1){ if(($page) == $i): ?><li  class="active"><a href="<?php echo ($pageurl); ?>page=<?php echo ($i); echo ($search); ?>"><?php echo ($i); ?></a></li>
                            <?php else: ?>
...
<script src="/Public/Admin/js/jjjl.js" type="text/javascript" charset="utf-8"></script>
<script>
