                    ...
                    <div class="tabbable" id="tabs-184023">
                        <div>
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#panel-32409" data-toggle="tab">修改管理员账户</a>
                                </li>
                            </ul>
                        </div>
                        <div class="wxts2"></div>
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel-32409">
                                <div class="xjzh">
                                    <div class="container-fluid">
                                        <form class="form-horizontal" id="form" name="form" method="post" action="/admin/index/doadminedit.html">
                                            <div class="row btred">
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">管理员帐户<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="text" class="form-control" id="username" name="username" value="<?php echo ($adata["adminname"]); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputPassword3" class="col-sm-3 control-label">登录密码<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="password" class="form-control" id="password" name="password" value="" placeholder="输入登录密码">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputPassword3" class="col-sm-3 control-label">确认登录密码<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="password" class="form-control" id="repassword" name="repassword" value="" placeholder="输入确认登录密码">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="inputPassword3" class="col-sm-3 control-label">姓名<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="text" class="form-control" id="realname" name="realname" placeholder="输入姓名" value="<?php echo ($adata["realname"]); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputPassword3" class="col-sm-3 control-label">职位<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <input type="text" class="form-control" id="job" name="job" placeholder="输入职位" value="<?php echo ($adata["job"]); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputPassword3" class="col-sm-3 control-label">权限<span>&nbsp;*</span></label>
                                                    <div class="input-group col-sm-4">
                                                        <?php if(is_array($room)): $i = 0; $__LIST__ = $room;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label name="power<?php echo ($vo["id"]); ?>" ><input type="checkbox"   name="power[]" value="<?php echo ($vo["id"]); ?>" onclick="checkboxClick('power','<?php echo ($vo["id"]); ?>',this);" <?php if(($vo["power"]) == "1"): ?>checked<?php endif; ?>> <?php echo ($vo["title"]); ?></label>
                                                            <br>
                                                            <?php if(is_array($vo["sub"])): $i = 0; $__LIST__ = $vo["sub"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;&nbsp;&nbsp;<label name="powersub<?php echo ($vo["id"]); ?>" onclick="checkboxClick('<?php echo ($vo["id"]); ?>',this);"><input type="checkbox"   name="power[]" value="<?php echo ($vo1["id"]); ?>" onclick="checkboxsubClick('<?php echo ($vo["id"]); ?>',this);" <?php if(($vo1["power"]) == "1"): ?>checked<?php endif; ?>> <?php echo ($vo1["title"]); ?></label><br><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-4 col-sm-offset-2">
                                                        <div class="but-box">
                                                            <input type="hidden" id="id" name="id" value="<?php echo ($adata["id"]); ?>">
                                                            <input type="submit" class="width-100" name="" id="" value="提交"  onclick="return Check()" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script src="/Public/Admin/js/adminedit.js" type="text/javascript" charset="utf-8"></script>