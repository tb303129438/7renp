                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">已开通会员数</th>
                            <th class="text-center">未开通会员数</th>
                            <th class="text-center">今日新增会员数</th>
                        </tr>
                        

                        <tr class="text-center">
                            <td><?php echo ($room["usertotal"]); ?></td>
                            <td><?php echo ($room["usertotal1"]); ?></td>
                            <td><?php echo ($room["usertotal2"]); ?></td>
                            <td><?php echo ($room["usertotal3"]); ?></td>
                        </tr>
                    </table>
                    <table class="table table-bordered">
                        <tr>
                            <th class="text-center">今日业绩</th>
                            <th class="text-center">今日推广积分</th>
                            <th class="text-center">今日消费积分</th>
                          
                        </tr>
                        

                        <tr class="text-center">
                            <td><?php echo ($room["usertotal4"]); ?></td>
                            <td><?php echo ($room['usertotal5']); ?></td>
                            <td><?php echo ($room['usertotal6']); ?></td>
