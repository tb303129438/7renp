...
<div class="zhegai"></div>
			...
			<div class="right_main">
				...
				<div class="tsy_box">
					<i class="tsy_ico"></i>注意：提交购车资料经审核后，方可进行提现
				</div>
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<div class="form_box">
								<form action="/pc/wo/dogcsq" method="post">
									
									<div class="inp_row">
										<p class="text_title">会员账号</p>
										<p class="input_box"><input type="text" name="username" id="username" value="<?php echo ($room["username"]); ?>" placeholder="请输入会员帐号"/></p>
									</div>
									<div class="inp_row">
										<p class="text_title">会员姓名</p>
										<p class="input_box"><input type="text" name="realname" id="realname" value="<?php echo ($room["realname"]); ?>" placeholder="请输入真实姓名" /></p>
									</div>
									<div class="inp_row">
										<p class="text_title">消费积分</p>
										<p class="input_box"><input type="text" name="price" id="price"  placeholder="请输入消费积分" /></p>
									</div>
									<div class="inp_row">
										<p class="text_title">所购车辆车型</p>
										<p class="input_box"><input type="text" name="by" id="by" value="" placeholder="请输入所购车辆车型" /></p>
									</div>
									<div class="inp_row">
										<p class="text_title">手机号码</p>
										<p class="input_box"><input type="text" name="mobile" id="mobile" value="<?php echo ($room["mobile"]); ?>" placeholder="请输入手机号码" /></p>
									</div>
									<div class="inp_row">
										<p class="text_title">提车日期</p>
										<p class="input_box"><input type="text" name="time" id="time" value="" placeholder="请输入提车日期" /></p>
									</div>
