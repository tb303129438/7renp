...
function Checkinfo(id)
{
    ...
    var mobile,weixin,alipay,address,limit;
    ...
    $.ajax({
        ...
        data: {'action':'checkinfo','id':id,'mobile':mobile,'weixin':weixin,'alipay':alipay,'address':address,'limit':limit},
        async:false,
        //dataType: "json",
...
function Checkpaper(id)
{
    ...
    $.ajax({
        type: "POST",
        url: "/admin/index/ajax",
        data: {'action':'checkpaper','id':id,'realname':realname,'paper':paper},
        async:false,
        //dataType: "json",
        success: function(data){
...
function Checkbank(id)
{
    ...
    $.ajax({
        type: "POST",
        url: "/admin/index/ajax",
        data: {'action':'checkbank','id':id,'bankname':bankname,'bank':bank,'bankcode':bankcode},
        async:false,
        //dataType: "json",
        success: function(data){
